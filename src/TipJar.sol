...
contract TipJar {
    ...
    uint256 public constant protocolFee = 5;
    ...
    function viewAmountOfClaimable(address recipient) public view returns (uint256) {
        return balance[recipient];
    }

    // and this is to like see how much amount of money is accumlated from the fees.
    function seeHowMuchAccumelatedFromFee() external view onlyOwner returns (uint256) {
