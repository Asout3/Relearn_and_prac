...
contract FlashLender {
    ...
    function flashLoan(address _receiver, address _token, uint256 _amount, bytes calldata data)
        external
        returns (bool)
    {
        ...
        require(
            Receiver.onFlashLoan(msg.sender, _token, _amount, fee, data) == CALLBACK_SUCCESS,
...
contract flashBorrower {
        ...
        returns (bytes32)
    {
        ...
        require(initiator == address(this), "untrusted intiator");
