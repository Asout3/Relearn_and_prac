...
/**
 *     THIS IS ONLY FOR EXERCISE IT IS NOT ONEDAY THING BUT MORE LIKE SIMPLE RESERACH AND PRACTICE AND EXERISCE
 *     IT HELP ME ALOT FROM UNDERSTANDING PROTOCOL DESIGN, IMPLEMENTATION AND TRADEOFFS AND IT IS REALLY GOOD EXPRIACE WORKING WITH THIS
 *     SO IN THE MAKING OF THIS I WROTE THE CODE EVEN THOUGH I USE AI TO LEARN AND HELP UNDERSTAND SOME DECISION AND IT PROBABLY HAVE SOME BUGS OR MISTAKE
 *     SO IT WILL RUN AND I HAVE COMPELETED MY EXERCISE PROPERLY YOU CAN READ THE COMMENTS TO REALLY UNDERSTAND MY THINKING PROCESS
 *     IT MIGHT BE MESSY AND NEED SOME REFACTORING BUT I HAVE OTHER EXERCISE TO PRACTICE SO YA THANK YOU SEE YOU ON THE NEXT EXERCISE.
 */
 ...
 * (current global - their last checkpoint)
 * (rewardPerTokenStored - lastCheckpoint[user]) / 1e18
 ...
 * it calculates
 * (rewardPerTokenStored - userRewardPerTokenPaid[alice]) / 1e18 // for precsison.
 * 100 // lets try to forget the 1e18 for now okay.
 * 100
 ...
 *    like we use here:
 * timePassed * 1e18) / totalStaked  //you can see it and every where
...
contract StakingRewards {
    ...
    constructor(address _stakingToken) {
        ...
        rewardToken = new RewardToken("Reward Token", "RT", 18, 0);
    }
